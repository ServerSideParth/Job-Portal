...
public class JobPostActivityService {
    ...
    public List<JobPostActivity> search(String job, String location, List<String> remote,
        ...
        return Objects.isNull(searchDate)? jobPostActivityRepository.searchWithoutDate(job,location,remote,
                type) : jobPostActivityRepository.search(job,location,remote,type,searchDate);
    }
}
